  ...
  if (
    ...
    if ($_FILES['lesson_link']['name'] != '') {
      ...
      if (in_array($file_ext, $allowed_extensions)) {
        ...
        throw new Exception('Invalid file. Allowed extensions: mp4, avi, mov, mkv.');
      }
    }
    ...
    // Append the video field to the update query only if a new video was uploaded
    if (!empty($llink)) {
      $sql .= ", lesson_link = '$llink'";
    }

    $sql .= " WHERE lesson_id = '$lid'";
