...
?>
  <div class="col-sm-9 mt-5">
    <div class="row mx-5 text-center">
      ...
      <div class="col-sm-4 mt-5">
        <div class="card text-white bg-success mb-3" style="max-width: 18rem;">
          <div class="card-header">Learners</div>
          <div class="card-body">
            <h4 class="card-title">
              <?php echo $totalLearner; ?>
            </h4>
            <a class="btn text-white" href="learners.php">View</a>
          </div>
        </div>
      </div>
      <div class="col-sm-4 mt-5">
        <div class="card text-white bg-info mb-3" style="max-width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a class="btn text-white" href="tutors.php">View</a>
          </div>
        </div>
      </div>
      <div class="col-sm-4 mt-5">
    ...
    <div class="mx-5 mt-5 text-center">
      ...
      <?php
      $sql = "SELECT * FROM courseorder";
      // $sql = "SELECT c.co_id, c.order_id, c.l_Email, c.order_date, c.amount, cs.course_name FROM courseorder AS c JOIN course AS cs ON cs.course_id = c.course_id";
      $result = $conn->query($sql);
