...
if (isset($_POST['submit'])) {
    $t_Email = $_POST['email'];
    $t_Pass = sha1($_POST['password']);
    $confirm_pass = sha1($_POST['confirmPassword']);

    // Form validation
    if (empty($t_Email) || empty($t_Pass) || empty($confirm_pass)) {
        $msg = "Please fill in all fields.";
    } elseif ($t_Pass !== $confirm_pass) {
        ...
        if ($NumRows == 1) {
            ...
            $update_sql = "UPDATE tutor SET t_Password = '$t_Pass' WHERE t_Email = '$t_Email'";
...
<body>
    <div class="container mt-4">
        <div class="row justify-content-center">
            <div class="col-md-4" style="border-radius: 11px;padding:22px;box-shadow:  17px 17px 49px #a1a1a1,
             -17px -17px 49px #ffffff;">
                <form method="post">
                    ...
                    <div class="mb-3 mt-4">
                        <a href="./t-signup.php" class="">Register</a>
                        <a href="./t-login.php" class="" style="float:right;">Login</a>
                    </div>
                    <?php if (!empty($msg)): ?>
