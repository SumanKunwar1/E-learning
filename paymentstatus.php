...
?>  
   ...
   <div class="container">
     ...
     <div class="form-group row">
        ...
        <div>
          <input class="form-control mx-3" style="    width: 240px; margin-bottom: 10px;" id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo $ORDER_ID ?>">
        </div>
        <div>
