...
session_start();
 if(!isset($_SESSION['stuLogEmail']) && !isset($_SESSION['email'])) {
  ...
  <div class="container mt-5">
    ...
    <h3 class="mb-5">Welcome to NextGen Payment Page</h3>
    <form method="post" action="./paymentdone.php" id="myform">
      ...
      <div class="form-group row">
       <label for="CUST_ID" class="col-sm-4 col-form-label">Learner Email</label>
       <div class="col-sm-8">
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=Ab2VPkOPXevsHdOrjeRa8z4rYMc53sfKi3eSljJS6Fld20CC-2WkNo6Us8z08ffUFfBH-zKCW9ZRJLQS&currency=USD"></script>
